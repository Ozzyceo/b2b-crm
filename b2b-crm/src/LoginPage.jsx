    ...
    <div className="login-page">
      ...
      <div className="login-container">
        <div className="login-brand">
          ...
          <div>
            <h1 className="login-title">B2B CRM</h1>
            <p className="login-subtitle">Insurance Team Platform</p>
          </div>
        </div>
        ...
        <div className="login-card">
          ...
          {mode === "signup" && (
            <p className="login-note">
              New accounts are created as <strong>Agent</strong>. Your director will
